...
# CSRF_TRUSTED_ORIGINS = ['https://*.aliburakpekisik.com','http://*.aliburakpekisik.com']
...
if DEBUG:
    ...
    PROJECTS_LOCATION = MEDIA_LOCATION + '/project_settings'
...
DEFAULT_FROM_EMAIL = 'Ali Burak PEKIŞIK <burakpekisik@gmail.com>'
